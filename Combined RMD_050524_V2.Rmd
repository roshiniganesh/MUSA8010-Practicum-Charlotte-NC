...
# 2017-2023 Ridership Data 
stops<-read_csv('New Data/merged_data.csv')
...
# Feature engineering CATS data

busstop_sf <- st_as_sf(stops, coords = c("Longitude", "Latitude"), crs = 4326)
...
stops_data <- busstop_sf %>%
  rename(Avg_Board_2023   = `2023_Avg_Board`)%>%
  rename(Avg_Alight_2023  = `2023_Avg_Alight`)%>%
  rename(Avg_Days_2023    = `2023_Max_Number_of_Days`)%>%
  rename(Avg_Board_2022   = `2022_Avg_Board`)%>%
  rename(Avg_Alight_2022  = `2022_Avg_Alight`)%>%
  rename(Avg_Days_2022    = `2022_Max_Number_of_Days`)%>%
  rename(Avg_Board_2021   = `2021_Avg_Board`)%>%
  rename(Avg_Alight_2021  = `2021_Avg_Alight`)%>%
  rename(Avg_Days_2021    = `2021_Max_Number_of_Days`)%>%
  rename(Avg_Board_2020   = `2020_Avg_Board`)%>%
  rename(Avg_Alight_2020  = `2020_Avg_Alight`)%>%
  rename(Avg_Days_2020    = `2020_Max_Number_of_Days`)%>%
  rename(Avg_Board_2019   = `2019_Avg_Board`)%>%
  rename(Avg_Alight_2019  = `2019_Avg_Alight`)%>%
  rename(Avg_Days_2019    = `2019_Max_Number_of_Days`)%>%
  rename(Avg_Board_2018   = `2018_Avg_Board`)%>%
  rename(Avg_Alight_2018  = `2018_Avg_Alight`)%>%
  rename(Avg_Days_2018    = `2018_Max_Number_of_Days`)%>%
  rename(Avg_Board_2017   = `2017_Avg_Board`)%>%
  rename(Avg_Alight_2017  = `2017_Avg_Alight`)%>%
  rename(Avg_Days_2017    = `2017_Max_Number_of_Days`)

stops_data$'Stop ID' <- str_remove(stops_data$'Stop ID', "^0+")
...
ggplot(stops_data) +
  ...
  geom_sf(aes(color = Avg_Board_2023), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2023 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2023), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2023 Average Alight Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Board_2022), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2022 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2022), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2022 Average Alight Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Board_2021), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2021 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2021), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2021 Average Alight Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Board_202), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2020 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2020), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2020 Average Alight Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Board_2019), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2019 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2019), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2019 Average Alight Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Board_2018), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2018 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2018), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2018 Average Alight Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Board_2017), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2017 Average Board Value")

ggplot(stops_data) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Avg_Alight_2017), size = .3) +
  scale_color_gradient(low = "#FFAB00", high = "darkgreen") +
  mapTheme() +
  labs(title = "Bus Stops", color = "2017 Average Alight Value")
```
...
stops_data <- stops %>%
  rename(Stop.Name = `Stop Name`)%>%
  rename(Stop.ID = `Stop ID`)

# Calculate the increase/decrease
average_board <- stops_data %>%
  group_by(Stop.Name,Stop.ID) %>%
...
```{r, warning=FALSE, message=FALSE}
normalized_2022 <- read_csv('New Data/data2022normalized.csv')
```


```{r, warning=FALSE, message=FALSE}
normalized_2023 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2023, Avg_Alight_2023, Avg_Days_2023, geometry)

normalized_2022 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2022, Avg_Alight_2022, Avg_Days_2022, geometry)

normalized_2021 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2021, Avg_Alight_2021, Avg_Days_2021, geometry)

normalized_2020 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2020, Avg_Alight_2020, Avg_Days_2020, geometry)

normalized_2019 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2019, Avg_Alight_2019, Avg_Days_2019, geometry)

normalized_2018 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2018, Avg_Alight_2018, Avg_Days_2018, geometry)

normalized_2017 <- stops_data%>%
 dplyr::select('Stop ID', 'Stop Name', geometry, Avg_Board_2017, Avg_Alight_2017, Avg_Days_2017, geometry)
...
normalized_2017_sf <- st_join(normalized_2017, dat2017, join = st_within)
```

```{r, warning=FALSE, message=FALSE}
# Perform spatial join based on containment (bus stops within census tracts)
normalized_2018_sf <- st_join(normalized_2018, dat2018, join = st_within)
```

```{r, warning=FALSE, message=FALSE}
# Perform spatial join based on containment (bus stops within census tracts)
normalized_2019_sf <- st_join(normalized_2019, dat2019, join = st_within)
```

```{r, warning=FALSE, message=FALSE}
# Perform spatial join based on containment (bus stops within census tracts)
normalized_2020_sf <- st_join(normalized_2020, dat2020, join = st_within)
```

```{r, warning=FALSE, message=FALSE}
# Perform spatial join based on containment (bus stops within census tracts)
normalized_2021_sf <- st_join(normalized_2021, dat2021, join = st_within)
```

```{r, warning=FALSE, message=FALSE}
# Perform spatial join based on containment (bus stops within census tracts)
normalized_2022_sf <- st_join(normalized_2022, dat2022, join = st_within)
```


```{r, warning=FALSE, message=FALSE}
a# Spatial join based on containment (bus stops within census tracts)
if (st_crs(stops_data) != st_crs(allTracts_sf)) {
  stops_data <- st_transform(stops_data, crs = st_crs(allTracts_sf))
}

# Spatial join
joined_data <- st_join(stops_data, allTracts_sf, join = st_within)

# Separate dataset
data_2017 <- filter(joined_data, year == 2017)
data_2018 <- filter(joined_data, year == 2018)
data_2019 <- filter(joined_data, year == 2019)
data_2020 <- filter(joined_data, year == 2020)
data_2021 <- filter(joined_data, year == 2021)
data_2022 <- filter(joined_data, year == 2022)
...
normalized_2022_sf <-
  normalized_2022_sf %>% 
    mutate(
      school_nn1 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(school.sf), k = 1),
      
      school_nn2 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(school.sf), k = 2), 
      
      school_nn3 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(school.sf), k = 3), 
      
      school_nn4 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(school.sf), k = 4), 
      
      school_nn5 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(school.sf), k = 5)) 

normalized_2022_sf <-
  normalized_2022_sf %>% 
    mutate(
      policeoffice_nn1 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(policeoffice.sf), k = 1),
      
      policeoffice_nn2 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(policeoffice.sf), k = 2), 
      
      policeoffice_nn3 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(policeoffice.sf), k = 3), 
      
      policeoffice_nn4 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(policeoffice.sf), k = 4), 
      
      policeoffice_nn5 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(policeoffice.sf), k = 5)) 

normalized_2022_sf <-
  normalized_2022_sf %>% 
    mutate(
      groceries_nn1 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(groceries.sf), k = 1),
      
      groceries_nn2 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(groceries.sf), k = 2), 
      
      groceries_nn3 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(groceries.sf), k = 3), 
      
      groceries_nn4 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(groceries.sf), k = 4), 
      
      groceries_nn5 = nn_function(st_coordinates(normalized_2022_sf), 
...
normalized_2022_sf <-
  normalized_2022_sf %>% 
    mutate(
      parks_nn1 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(parks.sf), k = 1),
      
      parks_nn2 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(parks.sf), k = 2), 
      
      parks_nn3 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(parks.sf), k = 3), 
      
      parks_nn4 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(parks.sf), k = 4), 
      
      parks_nn5 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(parks.sf), k = 5)) 

normalized_2022_sf <-
  normalized_2022_sf %>% 
    mutate(
      shoppingcen_nn1 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(shoppingcen.sf), k = 1),
      
      shoppingcen_nn2 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(shoppingcen.sf), k = 2), 
      
      shoppingcen_nn3 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(shoppingcen.sf), k = 3), 
      
      shoppingcen_nn4 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(shoppingcen.sf), k = 4), 
      
      shoppingcen_nn5 = nn_function(st_coordinates(normalized_2022_sf), 
...
normalized_2022_sf <-
  normalized_2022_sf %>% 
    mutate(
      transit_stops_nn1 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(existing_transit_stops), k = 1),
      
      transit_stops_nn2 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(existing_transit_stops), k = 2), 
      
      transit_stops_nn3 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(existing_transit_stops), k = 3), 
      
      transit_stops_nn4 = nn_function(st_coordinates(normalized_2022_sf), 
                              st_coordinates(existing_transit_stops), k = 4), 
      
      transit_stops_nn5 = nn_function(st_coordinates(normalized_2022_sf), 
...
normalized_2022_sf$dist_to_center <- st_distance(normalized_2022_sf$geometry, city_center)
```
...
OLS_testing <- OLS_test_data %>%
  mutate(
    ...
    Error = Predictions - OLS_test_data$Avg_ridership_2022,
    AbsError = abs(Predictions - OLS_test_data$Avg_ridership_2022),
    MAE = mean(abs(Error), na.rm = TRUE),
    APE = abs(Predictions - OLS_test_data$Avg_ridership_2022) / Predictions)
summary(OLS)
```
...
OLSactual <- OLS_test_data$Avg_ridership_2022
...
train_index <- sample(1:nrow(normalized_2022_sf), 0.7 * nrow(normalized_2022_sf)) 
train_data_RF <- normalized_2022_sf[train_index, ]
train_data_RF <- na.omit(train_data_RF)
test_data_RF <- normalized_2022_sf[-train_index, ]
test_data_RF<-na.omit(test_data_RF)

# Fit the Random Forest model
RF_model <- randomForest(
  formula = Avg_ridership_2022 ~ TotalPop + MedHHInc + MedRent + Commutetowork + pctWhite + pctAfricanamerican + pctAsian + pctOther + pctMale + pctFemale + pctBachelors + pctWorker + pctPoverty + pctworkwithbus + pctworkfromhome + pctworkbycar + pctworkbytaxi + pctworkbymotor + pctworkbybike + pctworkbywalk + pctnocar + pct1car + pct2car + pct3car + pct4car + pct5car + policeoffice_nn1 + policeoffice_nn2 + policeoffice_nn3 + policeoffice_nn4 + policeoffice_nn5 + groceries_nn1 + groceries_nn2 + groceries_nn3 + groceries_nn4 + groceries_nn5 + parks_nn1 + parks_nn2 + parks_nn3 + parks_nn4 + parks_nn5 + shoppingcen_nn1 + shoppingcen_nn2 + shoppingcen_nn3 + shoppingcen_nn4 + shoppingcen_nn5 + PopDensity_km2 +Avg_Days_2022, 
  data = train_data_RF)


RF_testing <- test_data_RF %>%
  mutate(Predictions_RF = predict(RF_model, newdata = test_data_RF),
Error_RF = Predictions_RF - test_data_RF$Avg_ridership_2022,
AbsError_RF = abs(Predictions_RF - test_data_RF$Avg_ridership_2022),
MAE_RF= mean(abs(Error_RF)),
APE_RF = (abs(Predictions_RF - test_data_RF$Avg_ridership_2022)) / Predictions_RF)
...
normalized_2022_sf$`Stop ID` <- gsub("\\s+", "", normalized_2022_sf$`Stop ID`)

#data_2022 <- data_2022 %>%
#  mutate('Stop ID' = as.numeric('Stop ID'),
#        'Stop ID' = sprintf("%d", 'Stop ID'))


# Perform a left join based on the common column "Stop ID"
merged_dataset_bus <- left_join(routes_df, normalized_2022_sf,   by = "Stop ID")
...
RF2_table <- merge(merged_dataset_bus, summarized_data2, by = c('Stop ID'), all.x = TRUE)
...
#file_path <- "prediction_rf2_top50.geojson"
...
ggplot() +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8, color = NA) +
  geom_sf(data = bus_routes, color = "darkgrey", size = 5, alpha = 0.5) +
  geom_sf(data = underperforming_stops_predicted2_m, aes(color = Predictions_RF2), size = 1) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
  labs(title = "Predicted Avg Ridership under 10 in January", color = "Predicted Ridership") +
  theme(legend.position = "bottom")

#file_path <- "prediction_rf2.geojson"
...
data_2017 <-
  data_2017 %>% 
    mutate(
      policeoffice_nn1 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(policeoffice.sf), k = 1),
      
      policeoffice_nn2 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(policeoffice.sf), k = 2), 
      
      policeoffice_nn3 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(policeoffice.sf), k = 3), 
      
      policeoffice_nn4 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(policeoffice.sf), k = 4), 
      
      policeoffice_nn5 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(policeoffice.sf), k = 5)) 

data_2017 <-
  data_2017 %>% 
    mutate(
      groceries_nn1 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(groceries.sf), k = 1),
      
      groceries_nn2 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(groceries.sf), k = 2), 
      
      groceries_nn3 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(groceries.sf), k = 3), 
      
      groceries_nn4 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(groceries.sf), k = 4), 
      
      groceries_nn5 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(groceries.sf), k = 5)) 
...
data_2017 <-
  data_2017 %>% 
    mutate(
      parks_nn1 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(parks.sf), k = 1),
      
      parks_nn2 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(parks.sf), k = 2), 
      
      parks_nn3 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(parks.sf), k = 3), 
      
      parks_nn4 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(parks.sf), k = 4), 
      
      parks_nn5 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(parks.sf), k = 5)) 
...
data_2017 <-
  data_2017 %>% 
    mutate(
      shoppingcen_nn1 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(shoppingcen.sf), k = 1),
      
      shoppingcen_nn2 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(shoppingcen.sf), k = 2), 
      
      shoppingcen_nn3 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(shoppingcen.sf), k = 3), 
      
      shoppingcen_nn4 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(shoppingcen.sf), k = 4), 
      
      shoppingcen_nn5 = nn_function(st_coordinates(data_2017), 
                              st_coordinates(shoppingcen.sf), k = 5)) 
...
# Remove spaces in "Stop ID" values
data_2017$`Stop ID` <- gsub("\\s+", "", data_2017$`Stop ID`)

# Perform a left join based on the common column "Stop ID"
merged_dataset_bus_2017 <- left_join(routes_df, data_2017,   by = "Stop ID")

merged_dataset_bus_2017 <- merged_dataset_bus_2017 %>%
  mutate("total_routes_in_stops" = str_count(routes, ",") + 1)


# Separate the routes into individual rows
separated_data_2017 <- merged_dataset_bus_2017 %>%
  separate_rows(routes, sep = ",\\s*")

count_stops_routes_2017 <- separated_data_2017 %>%
  group_by(routes) %>%
  summarise(total_stops_in_routes = n_distinct(`Stop ID`))

# Merge the count_stops_data back to the original_data based on routes and counts
merge_count_data_2017 <- left_join(separated_data_2017, count_stops_routes, by = "routes")

merge_count_data_2017 <- merge_count_data_2017 %>%
  mutate("total_routes_in_stops" = str_count(routes, ",") + 1)


summarized_data2_2017 <- merge_count_data_2017 %>%
  group_by(`Stop ID`, Month) %>%
  summarize(total_stops_in_served_routes = sum(total_stops_in_routes, na.rm = TRUE))


# Merge the summarized data back with the original 'bus_2022' dataset
RF2_table_2017 <- merge(merged_dataset_bus_2017, summarized_data2_2017, by = c('Stop ID', 'Month'), all.x = TRUE)


RF2_table_2017_sf <- st_as_sf(RF2_table_2017)
...
# Simulate 10% increase in PopDensity
data_2017_scenario1 <- data_2017 %>% 
  mutate(PopDensity_km2 = PopDensity_km2 * 1.1)

# Make Predictions with the New Scenario Data
predictions_2017_scenario1 <- predict(RF_model, newdata = data_2017_scenario1)

# Add Predictions to the Data
data_2017_scenario1$Predicted_Avg_ridership <- predictions_2017_scenario1

# Format Predicted Avg Ridership as Decimal Numbers
data_2017_scenario1$Predicted_Avg_ridership <- sprintf("%.2f", predictions_2017_scenario1)

# Convert Data to an sf Object
data_2017_scenario1_sf <- st_as_sf(data_2017_scenario1, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
data_2017_scenario1_sf$Predicted_Avg_ridership <- as.numeric(data_2017_scenario1_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(data_2017_scenario1_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
  labs(title = "Bus Stops 2017", color = "Predicted Avg Ridership with \n10% Increase in Population Density")
...
# Format Predicted Avg Ridership as Decimal Numbers
RF2_table_2022_scenario1$Predicted_Avg_ridership <- sprintf("%.2f", predictions2_2022_scenario1)
...
# Convert Predicted Avg Ridership to Numeric
RF2_table_2022_scenario1_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2022_scenario1_sf$Predicted_Avg_ridership)

result <- RF2_table_2022_scenario1_sf[RF2_table_2022_scenario1_sf$Predicted_Avg_ridership <= 10, ]
...
# Simulate 10% increase in PopDensity
RF2_table_2017_scenario1 <- RF2_table_2017_sf %>% 
  mutate(PopDensity_km2 = PopDensity_km2 * 1.1)

# Make Predictions with the New Scenario Data
predictions2_2017_scenario1 <- predict(RF_model2, newdata = RF2_table_2017_scenario1)

# Add Predictions to the Data
RF2_table_2017_scenario1$Predicted_Avg_ridership <- predictions2_2017_scenario1

# Format Predicted Avg Ridership as Decimal Numbers
RF2_table_2017_scenario1$Predicted_Avg_ridership <- sprintf("%.2f", predictions2_2017_scenario1)

# Convert Data to an sf Object
RF2_table_2017_scenario1_sf <- st_as_sf(RF2_table_2017_scenario1, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
RF2_table_2017_scenario1_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2017_scenario1_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2017_scenario1_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Simulate 30% increase in PopDensity
data_2017_scenario1a <- data_2017 %>% 
  mutate(PopDensity_km2 = PopDensity_km2 * 1.3)

# Make Predictions with the New Scenario Data
predictions_2017_scenario1a <- predict(RF_model, newdata = data_2017_scenario1a)

# Add Predictions to the Data
data_2017_scenario1a$Predicted_Avg_ridership <- predictions_2017_scenario1a

# Format Predicted Avg Ridership as Decimal Numbers
data_2017_scenario1a$Predicted_Avg_ridership <- sprintf("%.2f", predictions_2017_scenario1a)

# Convert Data to an sf Object
data_2017_scenario1a_sf <- st_as_sf(data_2017_scenario1a, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
data_2017_scenario1a_sf$Predicted_Avg_ridership <- as.numeric(data_2017_scenario1a_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(data_2017_scenario1a_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Convert Predicted Avg Ridership to Numeric
RF2_table_2022_scenario1a_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2022_scenario1a_sf$Predicted_Avg_ridership)


result <- RF2_table_2022_scenario1a_sf[RF2_table_2022_scenario1a_sf$Predicted_Avg_ridership <= 10, ]
result <- result[result$Month == 'January', ]
...
# Simulate 30% increase in PopDensity
RF2_table_2017_scenario1a <- RF2_table_2017_sf %>% 
  mutate(PopDensity_km2 = PopDensity_km2 * 1.1)

# Make Predictions with the New Scenario Data
predictions2_2017_scenario1a <- predict(RF_model2, newdata = RF2_table_2017_scenario1a)

# Add Predictions to the Data
RF2_table_2017_scenario1a$Predicted_Avg_ridership <- predictions2_2017_scenario1a

# Format Predicted Avg Ridership as Decimal Numbers
RF2_table_2017_scenario1a$Predicted_Avg_ridership <- sprintf("%.2f", predictions2_2017_scenario1a)

# Convert Data to an sf Object
RF2_table_2017_scenario1a_sf <- st_as_sf(RF2_table_2017_scenario1a, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
RF2_table_2017_scenario1a_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2017_scenario1a_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2017_scenario1a_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Simulate 10% increase in Income
data_2017_scenario2 <- data_2017 %>% 
  mutate(MedHHInc = MedHHInc * 1.1)

# Make Predictions with the New Scenario Data
predictions_2017_scenario2 <- predict(RF_model, newdata = data_2017_scenario2)

# Add Predictions to the Data
data_2017_scenario2$Predicted_Avg_ridership <- predictions_2017_scenario2

# Format Predicted Avg Ridership as Decimal Numbers
data_2017_scenario2$Predicted_Avg_ridership <- sprintf("%.2f", predictions_2017_scenario2)

# Convert Data to an sf Object
data_2017_scenario2_sf <- st_as_sf(data_2017_scenario2, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
data_2017_scenario2_sf$Predicted_Avg_ridership <- as.numeric(data_2017_scenario2_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(data_2017_scenario2_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Convert Predicted Avg Ridership to Numeric
RF2_table_2022_scenario2_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2022_scenario2_sf$Predicted_Avg_ridership)


result <- RF2_table_2022_scenario2_sf[RF2_table_2022_scenario2_sf$Predicted_Avg_ridership <= 10, ]
result <- result[result$Month == 'January', ]
...
# Simulate 10% increase in PopDensity
RF2_table_2017_scenario2 <- RF2_table_2017_sf %>% 
  mutate(MedHHInc = MedHHInc * 1.1)

# Make Predictions with the New Scenario Data
predictions2_2017_scenario2 <- predict(RF_model2, newdata = RF2_table_2017_scenario2)

# Add Predictions to the Data
RF2_table_2017_scenario2$Predicted_Avg_ridership <- predictions2_2017_scenario2

# Format Predicted Avg Ridership as Decimal Numbers
RF2_table_2017_scenario2$Predicted_Avg_ridership <- sprintf("%.2f", predictions2_2017_scenario2)

# Convert Data to an sf Object
RF2_table_2017_scenario2_sf <- st_as_sf(RF2_table_2017_scenario2, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
RF2_table_2017_scenario2_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2017_scenario2_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2017_scenario2_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
  labs(title = "Bus Stops 2017", color = "Predicted Avg Ridership with \n30% Increase in Median Income")
...
# Simulate 30% increase in Income
data_2017_scenario2a <- data_2017 %>% 
  mutate(MedHHInc = MedHHInc * 1.3)

# Make Predictions with the New Scenario Data
predictions_2017_scenario2a <- predict(RF_model, newdata = data_2017_scenario2a)

# Add Predictions to the Data
data_2017_scenario2a$Predicted_Avg_ridership <- predictions_2017_scenario2a

# Format Predicted Avg Ridership as Decimal Numbers
data_2017_scenario2a$Predicted_Avg_ridership <- sprintf("%.2f", predictions_2017_scenario2a)

# Convert Data to an sf Object
data_2017_scenario2a_sf <- st_as_sf(data_2017_scenario2a, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
data_2017_scenario2a_sf$Predicted_Avg_ridership <- as.numeric(data_2017_scenario2a_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(data_2017_scenario2a_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
  labs(title = "Bus Stops", color = "Predicted Avg Ridership with \n30% Increase in MedHHInc")
...
# Convert Predicted Avg Ridership to Numeric
RF2_table_2022_scenario2a_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2022_scenario2a_sf$Predicted_Avg_ridership)


result <- RF2_table_2022_scenario2a_sf[RF2_table_2022_scenario2a_sf$Predicted_Avg_ridership <= 10, ]
result <- result[result$Month == 'January', ]
...
# Simulate 10% increase in PopDensity
RF2_table_2017_scenario2a <- RF2_table_2017_sf %>% 
  mutate(MedHHInc = MedHHInc * 1.3)

# Make Predictions with the New Scenario Data
predictions2_2017_scenario2a <- predict(RF_model2, newdata = RF2_table_2017_scenario2a)

# Add Predictions to the Data
RF2_table_2017_scenario2a$Predicted_Avg_ridership <- predictions2_2017_scenario2a

# Format Predicted Avg Ridership as Decimal Numbers
RF2_table_2017_scenario2a$Predicted_Avg_ridership <- sprintf("%.2f", predictions2_2017_scenario2a)

# Convert Data to an sf Object
RF2_table_2017_scenario2a_sf <- st_as_sf(RF2_table_2017_scenario2a, geom = "geometry")


# Convert Predicted Avg Ridership to Numeric
RF2_table_2017_scenario2a_sf$Predicted_Avg_ridership <- as.numeric(RF2_table_2017_scenario2a_sf$Predicted_Avg_ridership)

# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2017_scenario2a_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
data_2022_s1 <-
  data_2022 %>% 
    mutate(
      proposed_line_nn1 = nn_function(st_coordinates(data_2022), 
                              st_coordinates(proposed_line_merged_data_sf), k = 1),
      
      proposed_line_nn2 = nn_function(st_coordinates(data_2022), 
                              st_coordinates(proposed_line_merged_data_sf), k = 2), 
      
      proposed_line_nn3 = nn_function(st_coordinates(data_2022), 
                              st_coordinates(proposed_line_merged_data_sf), k = 3), 
      
      proposed_line_nn4 = nn_function(st_coordinates(data_2022), 
                              st_coordinates(proposed_line_merged_data_sf), k = 4), 
      
      proposed_line_nn5 = nn_function(st_coordinates(data_2022), 
