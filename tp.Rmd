...
for(i in tp_vars){
  map <- ggplot() +
         geom_sf(data = dat2017,aes(fill = (!!sym(i)))) +
...
for(i in tp_vars){
  map <- ggplot() +
         geom_sf(data = dat2018,aes(fill = (!!sym(i)))) +
         scale_fill_gradient(low = "#efedf5", high = "#54278f") + 
         geom_point(data=AllData,aes(x=Longitude, y= Latitude), color = "black", size = 0.5)+
         labs(title = tp_titles[j], caption = paste0("Figure ", as.character(j)))
  mapList[[i]] <- map
...
for(i in tp_vars){
  map <- ggplot() +
         geom_sf(data = dat2019,aes(fill = (!!sym(i)))) +
         scale_fill_gradient(low = "#efedf5", high = "#54278f") + 
         geom_point(data=AllData,aes(x=Longitude, y= Latitude), color = "black", size = 0.5)+
         labs(title = tp_titles[j], caption = paste0("Figure ", as.character(j)))
  mapList[[i]] <- map
...
for(i in tp_vars){
  map <- ggplot() +
         geom_sf(data = dat2020,aes(fill = (!!sym(i)))) +
         scale_fill_gradient(low = "#efedf5", high = "#54278f") + 
         geom_point(data=AllData,aes(x=Longitude, y= Latitude), color = "black", size = 0.5)+
         labs(title = tp_titles[j], caption = paste0("Figure ", as.character(j)))
  mapList[[i]] <- map
...
for(i in tp_vars){
  map <- ggplot() +
         geom_sf(data = dat2021,aes(fill = (!!sym(i)))) +
         scale_fill_gradient(low = "#efedf5", high = "#54278f") + 
         geom_point(data=AllData,aes(x=Longitude, y= Latitude), color = "black", size = 0.5)+
         labs(title = tp_titles[j], caption = paste0("Figure ", as.character(j)))
  mapList[[i]] <- map
...
for(i in tp_vars){
  map <- ggplot() +
         geom_sf(data = dat2022,aes(fill = (!!sym(i)))) +
         scale_fill_gradient(low = "#efedf5", high = "#54278f") + 
         geom_point(data=AllData,aes(x=Longitude, y= Latitude), color = "black", size = 0.5)+
         labs(title = tp_titles[j], caption = paste0("Figure ", as.character(j)))
  mapList[[i]] <- map
