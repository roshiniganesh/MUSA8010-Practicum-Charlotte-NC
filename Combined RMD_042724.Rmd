...
```{r Trends by Year, warning=FALSE, message=FALSE, fig.width=8, fig.height=8}
...
#  data_2022 %>% 
#    mutate(
#      transits_nn1 = nn_function(st_coordinates(data_2022), 
#                              st_coordinates(transits.sf), k = 1),
      
#      transits_nn2 = nn_function(st_coordinates(data_2022), 
#                              st_coordinates(transits.sf), k = 2), 
      
#      transits_nn3 = nn_function(st_coordinates(data_2022), 
#                              st_coordinates(transits.sf), k = 3), 
      
#      transits_nn4 = nn_function(st_coordinates(data_2022), 
#                              st_coordinates(transits.sf), k = 4), 
      
#      transits_nn5 = nn_function(st_coordinates(data_2022), 
#                              st_coordinates(transits.sf), k = 5)) 
...
routes_test <- st_read("C:/Users/jonat/OneDrive - PennO365/Documents/MUSA 8010/Practicum_Charlotte_2024/CATS_BusStops/CATS_BusStops.shp")
...
#  data_2017 %>% 
#    mutate(
#      transits_nn1 = nn_function(st_coordinates(data_2017), 
#                              st_coordinates(transits.sf), k = 1),
      
#      transits_nn2 = nn_function(st_coordinates(data_2017), 
#                              st_coordinates(transits.sf), k = 2), 
      
#      transits_nn3 = nn_function(st_coordinates(data_2017), 
#                              st_coordinates(transits.sf), k = 3), 
      
#      transits_nn4 = nn_function(st_coordinates(data_2017), 
#                              st_coordinates(transits.sf), k = 4), 
      
#      transits_nn5 = nn_function(st_coordinates(data_2017), 
#                              st_coordinates(transits.sf), k = 5)) 
...
###### Increase in Population Density 10% (2022 & 2017)
...
# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2022_scenario1_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2022_scenario1a_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2022_scenario2_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
# Plot the Map with Correct Fill Scale
ggplot(RF2_table_2022_scenario2a_sf) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(aes(color = Predicted_Avg_ridership), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
proposed_line_merged_data <- rbind(red_stops, silver_stops)
...
ggplot() +
  geom_sf(data = dat2020, fill = "grey90", alpha = 0.5, color = NA) +
  geom_sf(data = bus_routes, color = "darkgrey", size = 5, alpha = 0.5) +
  geom_sf(data = proposed_line_merged_data, color = "darkgrey", size = .5, alpha = 0.5) +
