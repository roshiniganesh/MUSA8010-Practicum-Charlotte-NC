...
ggplot(result) +
  geom_sf(data = allTracts_sf, fill = "grey90", alpha = 0.8 , color = NA)+
  geom_sf(data = bus_routes, color = "darkgrey", size = 5, alpha = 0.5) +
  geom_sf(aes(color = Monthly_prediction), size = .5) +
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
...
file_path <- "Scenario Geojson File/Predicted_Avg_ridership_Under10_January_ScenarioI.geojson"
# Save the sf object to a GeoJSON file using geojsonio
geojson_write(result_sf, file= file_path)
...
file_path <- "Scenario Geojson File/Predicted_Avg_ridership_Under10_January_ScenarioIa(30%).geojson"
# Save the sf object to a GeoJSON file using geojsonio
geojson_write(result_sf, file= file_path)
...
file_path <- "Scenario Geojson File/Predicted_Avg_ridership_Under10_January_ScenarioII.geojson"
# Save the sf object to a GeoJSON file using geojsonio
geojson_write(result_sf, file= file_path)
...
file_path <- "Scenario Geojson File/Predicted_Avg_ridership_Under10_January_ScenarioIIa(30%).geojson"
# Save the sf object to a GeoJSON file using geojsonio
geojson_write(result_sf, file= file_path)
...
ggplot(result) +
  ...
  scale_color_gradient(low = "#FFBD37", high = "#005357") +
  mapTheme() +
  labs(title = "Predicted Avg Ridership under 10 in January: Scenario III", color = "Predicted Avg Ridership with proposed transit lines added")


result_sf <- st_as_sf(result)

file_path <- "Scenario Geojson File/Predicted_Avg_ridership_Under10_January_ScenarioIII(30%).geojson"
# Save the sf object to a GeoJSON file using geojsonio
geojson_write(result_sf, file= file_path)
